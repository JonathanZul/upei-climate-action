          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            ...
            <div className="flex flex-col space-y-6 mt-[-4px]">
              ...
              <div className="space-y-4">
                <a href="#" className="flex w-full items-center justify-center gap-3 rounded-full bg-accent-bg px-4 py-3 font-poppins text-sm font-semibold text-white- transition-transform hover:scale-105">
                  <Instagram />
